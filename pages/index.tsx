    ...
    if (!roomId) {
      ...
      */
      ...
      supabaseClient
        .from("current-stage")
        .select("stage")
        .then((resp: PostgrestResponse<{ stage: string }>) => {
          if (resp.data) {
            setCurrentStage(resp.data[0].stage);
          }
        });
    }
  ...
  useEffect(() => {
    ...
    postgresChannel = supabaseClient
      ...
      .on(
        ...
        (payload) => {
          if (payload.table === "current-stage") {
    ...
    >
      ...
      <div className="flex flex-col h-full justify-between">
        <div className="flex justify-between">
          <WaitlistPopover stage={currentStage} />
          <Users users={users} />
        </div>
      ...
      <div className="absolute bottom-4 left-0 w-full flex items-center justify-center space-x-2 pointer-events-none">
